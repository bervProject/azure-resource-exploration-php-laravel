...
@section('content')
      ...
      No file uploaded
                    ...
                    <a class="button is-link" href="/blob/list">Explore Blob</a>
                    </div>                                  
            </div>
            <div class="column">
                <div class="box">
                    ...
                    <form action="/cognitive/upload" method="POST" class="form" enctype="multipart/form-data">
                        @csrf
                        <div class="field">
                            <label class="label">File</label>
                            <div class="control">
                                <div id="azure-cognitive" class="file has-name">
                                    <label class="file-label">
                                        <input class="file-input" type="file" name="blobfile" accept="image/*">
                                        <span class="file-cta">
                                        <span class="file-icon">
                                            <i class="fas fa-upload"></i>
                                        </span>
